...
[**COORD 0.8.2 Mac prerelease**](https://github.com/nddn121415/COORD-STARTUP/releases/tag/desktop-v0.8.2) targets Apple silicon/macOS 13+. It is ad-hoc signed, not Apple-notarized. It defaults to `https://coord-startup-control-plane.vercel.app`; `COORD_WEBSITE_URL` overrides this when building for another deployment. Use 0.8 or later for HTTPS projects; old clients get an update message. Follow the [private two-computer test guide](docs/PRIVATE_TEST.md) before expanding the test group.
